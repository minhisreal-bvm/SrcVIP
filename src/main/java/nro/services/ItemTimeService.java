...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUseBanhChung) {
            sendItemTime(player, 25509, (int) ((TIME_BANH_CHUNG - (System.currentTimeMillis() - player.itemTime.lastTimeBanhChung)) / 1000));
        }
        if (player.itemTime.isUseBanhTet) {
            sendItemTime(player, 25510, (int) ((TIME_BANH_CHUNG - (System.currentTimeMillis() - player.itemTime.lastTimeBanhTet)) / 1000));
        }
