...
public static final String INFOR_TRAIN_OFFLINE = "Tập luyện vẫn tiếp tục và sức mạnh vẫn tăng khi Offline\n"
    ...
    public static final String CALICK_KE_CHUYEN = "20 năm trước bọn Android sát thủ đã đánh bại nhóm bảo vệ trái đất của Sôngoku và Cađíc, Pôcôlô ...\n"
            ...
            + "Cháu và mẹ may mắn sống sót nhờ lẩn trốn tại tầng hầm của công ty Capsule...\n"
    ...
    public static final byte NPC_NGOAI_VUC = 89;
    public static final byte NGUYET_THIEN_TIEN_TU = 90;
    ...
    public static final int SHOP_NGUYET_THIEN_TIEN_TU_1 = 525;
    public static final int SHOP_NGUYET_THIEN_TIEN_TU_2 = 526;
    ...
    public static final int DE_TU_KAIDO = 1009;
