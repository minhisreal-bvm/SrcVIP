...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        if (this.player.isPet && (((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA
            ...
            } else if (((Pet) this.player).typePet == 5) {//kaido
                this.hpMax += calPercent(this.hpMax, 400);
            }
        }
    ...
    private void setMpMax() {
        ...
        if (this.player.setClothes.mathan == 5) {
            this.mpMax += calPercent(this.mpMax, 400);
        }
        //set nhật ấn
        ...
        if (this.player.isPet && (((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA
            ...
            if (((Pet) this.player).typePet == 1) {//mabu
                ...
                this.mpMax += calPercent(this.mpMax, 300);
            } else if (((Pet) this.player).typePet == 5) {//kaido
                this.mpMax += calPercent(this.mpMax, 400);
            }
        }
    ...
    private void setCrit() {
        ...
        //set nhanhoang
        if (this.player.setClothes.nhanhoang == 5) {
            this.crit += calPercent(this.crit, 20);
        }
        //biến khỉ
        if (this.player.effectSkill.isMonkey) {
            this.crit = 110;
...
//        System.out.println(dameAttack);
    ...
    public long calSubTNSM(long tiemNang) {
        ...
        if (tiemNang > 500_000_000L) {
            tiemNang = 500_000_000L;
        }
        return tiemNang;
    }
