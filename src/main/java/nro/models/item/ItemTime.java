...
public class ItemTime {
    ...
    public static final int TIME_BANH_CHUNG = 1800000;
    ...
    public void update() {
        ...
        if (isUseBanhChung) {
            if (Util.canDoWithTime(lastTimeBanhChung, TIME_BANH_CHUNG)) {
                isUseBanhChung = false;
                update = true;
            }
        }
        if (isUseBanhTet) {
            if (Util.canDoWithTime(lastTimeBanhTet, TIME_BANH_CHUNG)) {
                isUseBanhTet = false;
                update = true;
            }
        }
