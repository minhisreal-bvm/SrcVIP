...
import nro.models.boss.BossDaiKhu.*;
import nro.models.boss.ThienDinh.*;
import nro.models.boss.BossDuyenKhang.*;
...
public class BossFactory {
    ...
    public static final byte TOPPO = -117;
    public static final byte BROLYFRIEZA = -118;
    public static final byte CAPTIAN = -119;
