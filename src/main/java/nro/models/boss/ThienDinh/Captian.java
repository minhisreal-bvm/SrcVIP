package nro.models.boss.ThienDinh;
 ...
 * @copyright 💖 GirlkuN 💖
 */
public class Captian extends Boss {

    public Captian() {
        super(BossFactory.CAPTIAN, BossData.CAPTIAN);
    }
    ...
    public void leaveMap() {
        BossFactory.createBoss(BossFactory.CAPTIAN).setJustRest();
        super.leaveMap();
