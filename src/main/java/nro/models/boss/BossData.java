...
public class BossData {
    ...
    public static final BossData TOPPO = new BossData(
            ...
            Boss.HP_NORMAL, //type hp
            7000000, //dame
           new long[][]{{500_000_000_000L}}, //hp
            new short[]{1412, 1413, 1414}, //outfit
            new short[]{214}, //map join
            new int[][]{ //skill
                    {Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},
                    {Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},
                    {Skill.GALICK, 1, 1000},{Skill.GALICK, 1, 1000},{Skill.GALICK, 1, 1000},{Skill.GALICK, 1, 1000},
                    {Skill.THAI_DUONG_HA_SAN, 7, 20000},{Skill.THAI_DUONG_HA_SAN, 7, 20000},{Skill.THAI_DUONG_HA_SAN, 7, 20000}
            },
            _10_PHUT
    );
    
    public static final BossData BROLYFRIEZA = new BossData(
            "Tam Thiên Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            Boss.DAME_NORMAL, //type dame
            Boss.HP_NORMAL, //type hp
            7000000, //dame
           new long[][]{{500_000_000_000L}}, //hp
            new short[]{1448, 1449, 1450}, //outfit
            new short[]{215}, //map join
            new int[][]{ //skill
                    {Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},{Skill.LIEN_HOAN, 7, 300},
                    {Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},{Skill.ANTOMIC, 7, 1000},
                    {Skill.GALICK, 7, 1000},{Skill.GALICK, 7, 1000},{Skill.GALICK, 7, 1000},{Skill.GALICK, 7, 1000},
                    {Skill.THAI_DUONG_HA_SAN, 7, 20000},{Skill.THAI_DUONG_HA_SAN, 7, 20000},{Skill.THAI_DUONG_HA_SAN, 7, 20000}
            },
            _10_PHUT
    );
    
    public static final BossData CAPTIAN = new BossData(
            "Tứ Thiên Tôn", //name
            ConstPlayer.TRAI_DAT, //gender
            Boss.DAME_NORMAL, //type dame
            Boss.HP_NORMAL, //type hp
            7000000, //dame
           new long[][]{{500_000_000_000L}}, //hp
            new short[]{1270, 1271, 1272}, //outfit
