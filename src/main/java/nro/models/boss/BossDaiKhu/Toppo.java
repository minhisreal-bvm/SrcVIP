package nro.models.boss.BossDaiKhu;
...
public class Toppo extends Boss {
    ...
    public void initTalk() {
        this.textTalkMidle = new String[]{"Đồ ngu, Đồ ăn Hại!", "Bú cu Tao không?",
            "Súc sinh.", "Tao sẽ thu phục mày."};

    }

    @Override
    public void leaveMap() {
        BossFactory.createBoss(BossFactory.TOPPO).setJustRest();
        super.leaveMap();
